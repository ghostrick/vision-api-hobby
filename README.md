...
iex(1) -> VisionApiHobby.Tag.detect_tags("./image/hoge.jpg")
%{
...
iex(2) -> VisionApiHobby.judge_image("./image/hoge.jpg", ["LABEL_DETECTION", "LANDMARK_DETECTION"])

# Function that download image and encode it with base64.
iex(3) -> VisionApiHobby.Utils.download_image_base64("https://.../hoge.jpg")
